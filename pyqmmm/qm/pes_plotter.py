...
def get_scatter_plot(energy_lists):
    ...
    colors = ['blue', 'red', '#9370DB', '#E63946', '#000000', '#2a9d8f']
    name_list = ['Weng', 'Vanholme', '3', '4', '5', '6']
    blue = "rgba(0, 0, 255, 1)"
    red = "rgba(255, 0, 0, 1)"
    ...
    for index, energy_list in enumerate(energy_lists):
        trace = go.Scatter(
            ...
            # x=np.linspace(1.07646078067, 1.8209230075, 70),
            y=energy_list,
            mode='markers+lines',
            opacity=0.8,
    ...
    layout["xaxis"].update({'title': "dihedral angle (°)"})
