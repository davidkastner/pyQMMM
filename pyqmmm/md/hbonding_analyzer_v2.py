...
if __name__ == "__main__":
    ...
    """
    # for mut in ['h127a', 'n212a']:
    #     for rep in ['rep1', 'rep2', 'rep3']:
    #         analyze_hbonds([f'/Users/lindseyguan/Documents/Kulik_lab/project/2_md/{mut}/{rep}/analysis/',
    #                         '/Users/lindseyguan/Documents/Kulik_lab/project/2_md/wt/analysis/'],
    #                        [mut.upper(), 'WT'])
