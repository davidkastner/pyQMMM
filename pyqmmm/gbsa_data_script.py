...
def clean_raw_data():
    ...
    df.columns = ['Resid 1', 'Resid 2', 'Internal Avg', 'Internal SD', 'Internal SDM', 'VDW Avg', 'VDW SD', 'VDW SDM', 'Electrostatic Avg', 'Electrostatic SD', 'Electrostatic SDM', 'Polar Solvation Avg', 'Polar Solvation SD', 'Polar Solvation SDM', 'Non-polar Solvation Avg', 'Non-polar Solvation SD', 'Non-polar Solvation SDM', 'Total Avg', 'Total SD', 'Total SDM']
